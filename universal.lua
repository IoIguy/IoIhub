...
local Window = Flux:Window("IoIhub", "Universal", Color3.fromRGB(255, 80, 74), Enum.KeyCode.N)
...
local Tab1 = Window:Tab("General", "http://www.roblox.com/asset/?id=8570194020")
...
local Tab2 = Window:Tab("Other", "http://www.roblox.com/asset/?id=8570195235")
Tab2:Button("Remove IoIhub", "Removes IoIhub from the game.", function()
